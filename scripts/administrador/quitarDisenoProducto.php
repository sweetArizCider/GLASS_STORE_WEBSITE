...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($codigo_diseno && $id_producto) {
        try {
            // Llamar al procedimiento almacenado para quitar el diseño
            ...
            $stmt->execute();
            $stmt->closeCursor();
            header("Location: ../../views/administrador/vista_admin_productos.php?status=success&message=Design removed successfully");
